...
elseif isfile("NexerHub/Core/PreloadData.luau") then
pcall(function()
...
_G.API_last_update = "16/12/2025" -- last time update (dd/mm/yyyy)
...
task.spawn(function()
Heartbeat.LoopNoStaminaLoss = function() if Char~=nil and Char:GetAttribute("MaxStamina")~=nil then StaminaModule.Stamina = tonumber(Char:GetAttribute("MaxStamina")) end end
repeat task.wait(0.003) until NoStaminaLoss == false
if Heartbeat.LoopNoStaminaLoss~=nil then
Heartbeat.LoopNoStaminaLoss = nil
end
end)
...
local getlmsdata = function() return ((pcall(function() loadstring(GetFile("NexerHub/DieOfDeath/Assets/LMS/data.luau","rf"))() end)==true and loadstring(GetFile("NexerHub/DieOfDeath/Assets/LMS/data.luau","rf"))()) or {}) end
local choosen_lms = ""
...
local getchasesdata = function() return ((pcall(function() loadstring(GetFile("NexerHub/DieOfDeath/Assets/Chases/data.luau","rf"))() end)==true and loadstring(GetFile("NexerHub/DieOfDeath/Assets/Chases/data.luau","rf"))()) or {}) end
local choosen_chase = ""
...
local RayfieldGuiTheme = "AmberGlow"
